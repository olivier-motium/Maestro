...
import maestro.cli.mcp.tools.ListWorkflowsTool
import maestro.cli.mcp.tools.RunWorkflowTool
...
fun runMaestroMcpServer(stdout: java.io.PrintStream = System.out) {
    ...
    server.addTools(listOf(
        ...
        ListWorkflowsTool.create(),
        RunWorkflowTool.create(sessionManager)
    ))
